...
convert_to_string:
  udiv w4, w9, w3      // Divide x1 por 10, resultado em w4
  msub w5, w4, w3, w9  // Calcula o resto: w5 = w1 - (w4 * w3)
  add w5, w5, #'0'     // Converte o dígito restante para ASCII
  strb w5, [x2, #-1]!  // Armazena o caractere no buffer (em ordem reversa)
  mov w9, w4           // Atualiza x1 para o quociente
...
print_number:
  ...
  // Teste
  // ldr x10, =resultadoValue

  mov x0, #1                    // Descritor de arquivo para stdout
  sub x1, x10, resultadoValue    // Calcula o número de caracteres armazenados no buffer
